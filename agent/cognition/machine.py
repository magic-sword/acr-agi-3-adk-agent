...
STATES = {
    ...
    'select_goal': ('小目標を選ぶ', 'llm', 350, 50),
    'assess_goal': ('小目標を評価', 'llm', 350, 210),
    'choose_method': ('方法を選ぶ', 'llm', 660, 50),
...
TRANSITIONS = {
    ...
    'initial_goal': ('observe','select_goal','小目標なし／区間変更','normal'),
    'existing_goal': ('observe','assess_goal','小目標あり','normal'),
    'measured': ('measure','assess_goal','画素・レベルの判定済み','normal'),
    'semantic': ('measure','judge_effect','意味判断が必要','normal'),
    'effect_judged': ('judge_effect','assess_goal','判定を保存','normal'),
    ...
    'measure_boundary': ('measure','select_goal','区間の切替','normal'),
    'judgment_boundary': ('judge_effect','select_goal','区間の切替','normal'),
    ...
    'target_found': ('inspect_target','validate','ホストが座標の包含を確認','normal'),
