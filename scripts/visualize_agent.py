...
<rect class="box" x="70" y="90" width="310" height="100" rx="12"/><text x="95" y="125" font-size="22">DECIDE</text><text x="95" y="160">One focused task per model invocation</text>
...
<text x="70" y="335">Goals · target inspection · experiment design · effect judgment · skill tasks</text><text x="70" y="375" font-size="12">Source edges: {detail}</text></svg>'''
